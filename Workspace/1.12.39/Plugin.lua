...
_G.Gitsync = {Connections = {} :: {RBXScriptConnection}; Loaded = false; ActiveExplorerWidgets = {} :: {DockWidgetPluginGui}}
...
for name, v in pairs(Config:GetAttributes()) do
	...
	if not _G.Gitsync[data[1]] then _G.Gitsync[data[1]] = {} end
	_G.Gitsync[data[1]][data[2]] = v
end

_G.Gitsync.Loaded = true ----> Stop yielding module threads
...
refreshButton.MouseButton1Click:Connect(function()
	...
	for i, widget: DockWidgetPluginGui in pairs(_G.Gitsync.ActiveExplorerWidgets) do widget:Destroy(); _G.Gitsync.ActiveExplorerWidgets[i] = nil; end
...
pushButton.MouseButton1Click:Connect(function()
	...
	if repoText ~= "" and tokenText ~= "" then
		...
		pushButton.ImageLabel.ImageColor3 = _G.Gitsync.Colors.Red
	end

	task.wait(waitTime)

	pushButton.ImageLabel.Image = ui.push.Value
	pushButton.ImageLabel.ImageColor3 = _G.Gitsync.Colors.White
...
pullButton.MouseButton1Click:Connect(function()
	...
	pullButton.ImageLabel.ImageColor3 = _G.Gitsync.Colors.Blue
	...
	if not (repoText ~= "" and tokenText ~= "") then
		warn("Enter both the repository name and token")
		pullButton.ImageLabel.ImageColor3 = _G.Gitsync.Colors.Red
	end
	...
	pullButton.ImageLabel.ImageColor3 = _G.Gitsync.Colors.White
...
tokenBox.FocusLost:Connect(function()
	plugin:SetSetting("REPOSITORY", tokenBox.Text)
end)
...
while task.wait(.05) do	----> 20 cycles per second
	...
	if plugin:GetSetting("OUTPUT_ENABLED") and settingsuiClone.Enabled then
		settingsFrame.PrintToggle.TextColor3 = _G.Gitsync.Colors.Green
		settingsFrame.PrintToggle.Text = "Printing All Output"
	else
		settingsFrame.PrintToggle.TextColor3 = _G.Gitsync.Colors.Red
